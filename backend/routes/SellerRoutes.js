...
const { registerSeller } = require('../controllers/sellersController/Auth/SignupController');
const { loginSeller } = require('../controllers/sellersController/Auth/LoginController');
// Routes
